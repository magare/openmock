...
const outDir = "evidence/qa/slot-probe";
...
for (const model of models) {
  for (const mode of modes) {
    await page.goto(`http://localhost:5199/scripts/inspect/slot-toggle-probe.html?model=${model}&mode=${mode}`, { waitUntil: "networkidle" });
